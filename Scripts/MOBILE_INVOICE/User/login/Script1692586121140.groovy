...
Mobile.setText(findTestObject('Object Repository/MOBILE/USER/login/txt_email'), 'nav54867@gmail.com', 0)
...
Mobile.tap(findTestObject('Object Repository/MOBILE/USER/login/btn_login'), 0)

Mobile.tap(findTestObject('MOBILE/USER/login/btn_owner'), 0)

Mobile.tap(findTestObject('MOBILE/USER/login/btn_select'), 0)
