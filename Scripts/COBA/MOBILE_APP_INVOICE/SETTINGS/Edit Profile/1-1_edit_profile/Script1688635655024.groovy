...
Mobile.tap(findTestObject('Mobile_APP_Invoice/SETTINGS/Edit Profile/android.widget.ImageView_(setting)'), 15)

Mobile.tap(findTestObject('Mobile_APP_Invoice/SETTINGS/Edit Profile/android.view.View_(edit_profile)'), 15)

Mobile.tap(findTestObject('Mobile_APP_Invoice/SETTINGS/Edit Profile/android.widget.EditText - Wahuda'), 15)

Mobile.tap(findTestObject('Mobile_APP_Invoice/SETTINGS/Edit Profile/android.widget.EditText - Amin'), 15)

Mobile.tap(findTestObject('Mobile_APP_Invoice/SETTINGS/Edit Profile/android.view.View_(save)'), 15)
